...
package conversandroid.voiceinterface;
 ...
 **********************************************************************************************************************************************************************/
    ...
    public void showRecordPermissionExplanation(){
        Toast.makeText(getApplicationContext(), "We need your permission to have access the microphone in order to perform speech recognition", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onRecordAudioPermissionDenied() {
        Toast.makeText(getApplicationContext(), "Sorry, this app cannot work without an access to the microphone", Toast.LENGTH_SHORT).show();
        System.exit(0);
    }
